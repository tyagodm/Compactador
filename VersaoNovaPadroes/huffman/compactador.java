...
{
 /*!Area de textos para exibição de possíveis mensagens*/
 ...
 /*!Instancia unica do compactador. Padrao Singleton. */
 private static compactador instancia = null;

 /*! Acesso a instancia unica do compactador. Singleton*/
  ...
  */
 protected compactador(JTextArea TextArea){
  ...
  */
 protected compactador(File arquivoIn){
   statusTextArea=null;
   fileIn = arquivoIn;
  ...
  */
 protected compactador(File arquivoIn, File arquivoOut){
   statusTextArea=null;
   fileIn = arquivoIn;
   fileOut = arquivoOut;
 }
 ...
 private void loadFiletoHeap() 
 {
	...
	{ // O tratamento dessa exececao eh obrigatorio.
	   if(statusTextArea!=null)
            statusTextArea.append("\n>> Erro durante a leitura!");
	   return ;
	}
